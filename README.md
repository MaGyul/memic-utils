...
2. **"대시보드"** 선택
3. 설치된 스크립트 목록에서 **"미덕 유저 스크립트 관리자"** 확인
...
#### 실제 사이트에서 작동 확인
1. **[미덕](https://memic.at)** 사이트 방문
2. Tampermonkey 아이콘에 **숫자 표시**가 나타나면 정상 작동
3. 아이콘을 클릭하여 **"미덕 유저 스크립트 관리자"**가 활성화되어 있는지 확인

![미덕 사이트에서 작동 확인](./assets/img/memic.at-check.png)
...
**3. 스크립트 활성화 상태 확인**
- Tampermonkey 대시보드에서 **"미덕 유저 스크립트 관리자"**가 활성화(녹색 점)되어 있는지 확인
...
- **memic.at** - 미덕 커뮤니티
- **shelter.id** - 미덕 전 쉘터 커뮤니티 (현재는 미덕으로 접속)
